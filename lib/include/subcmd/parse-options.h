...
/* parse_options() will filter out the processed options
 * and leave the non-option argments in argv[].
 * Returns the number of arguments left in argv[].
 *
 * NOTE: parse_options() may call exit() in the case of an error
 * (or for 'special' options like --list-cmds or --list-opts).
 */
